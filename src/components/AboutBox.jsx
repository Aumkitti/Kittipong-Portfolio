        ...
        <div className="col">
          <div className="about-info">
            ...
            <p>
              ...
              CSS, Bootstrap, Tailwind, JavaScript, React, Node.js, Express.js,
              Java, MySQL, PostgreSQL, Robot, and MongoDB. I enjoy creating dynamic and
            ...
            <div className="about-btn">
              <a href={cv} download>
                <button className="btn">
                  Download Resume <i className="uil uil-import"></i>
                </button>
              </a>
            </div>
          </div>
